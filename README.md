...
|---|---|---|
| **SQL Log Analysis** | Investigate security logs using SQL filtering queries | [View Project](./apply-filters-to-sql-queries) |
| **Linux Permissions** | Manage file/directory permissions using `chmod` and `ls -l` | [View Project](./use-linux-commands-to-manage-file-permissions) |
| **Vulnerability Assessment** | NIST SP 800-30 vulnerability assessment & threat matrix | [View Project](./vulnerability-assessment-report) |
| **DoS Incident Analysis** | NIST CSF incident analysis for a SYN flood attack | [View Project](./incident-report-analysis) |
| **IT Security Audit** | Internal audit & controls assessment for Botium Toys | [View Project](./botium-toys-it-security-audit) |
| **Incident Handler's Journal** | 4-part incident logging, phishing triage, & post-incident review | [View Project](./incident-handler's-journal) |
